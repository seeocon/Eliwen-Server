...
public class InterfaceManager {
	...
	public String getTime() {
		...
		//DateFormat format = new SimpleDateFormat("h:mm a zzz");
		//format.setTimeZone(TimeZone.getTimeZone("Toronto"));
		return Settings.SERVER_NAME + " Portal";
	}
	...
	public void sendRunePortal() 	{
            ...
            player.getPackets().sendIComponentText(506, 4, "Skilling");
            player.getPackets().sendIComponentText(506, 6, "Bosses");
            player.getPackets().sendIComponentText(506, 8, "Minigames");
            player.getPackets().sendIComponentText(506, 10,"PvP Tele");
            player.getPackets().sendIComponentText(506, 12,"Training");
            player.getPackets().sendIComponentText(506, 14,"Misc.");
