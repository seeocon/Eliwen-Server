...
public class PvmRewards {
	...
	public static void openInterface(Player player) {
		...
		sendString(player, new int[]{ 163, 165, 302 }, 90, "No title here right now!");
		sendString(player, new int[]{ 170, 171, 314 }, 67, "No title here right now!");
		sendString(player, new int[]{ 318, 319, 326 }, 91, "No title here right now!");
