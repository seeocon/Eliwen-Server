...
public class TitleHandler {
	...
	public enum Title {
		...
		Owner(59, "Owner ", false, "9BBC74", "", false, 0, 0),
		Admin(60, "Admin ", false,  "FF9900", "", false, 0, 0),
		Moderator(61, "Moderator ",  false, "FF9500", "", false, 0, 0),

		R_Donator(62, "R. Donator ",  false, "FF0000", "", false, 0, 0),
		S_Donator(63, "S. Donator ",  false, "0085F2", "", false, 0, 0),
		E_Donator(64, "E. Donator ",  false, "00FF00", "", false, 0, 0),
		...
		Fighter(67, "N/A ", false, "AF0000", "", true, 0, 0),
		Survivor(90, "N/A ", false, "AF0000", "", true, 0, 0),
		Guardian(91, "N/A ", false, "AF0000", "", true, 0, 0);
	...
	public static void set(Player player, int titleId) {
		...
		/*if (titleId == 91) {
			player.sendMessage("Congrats on being a noob!");
			player.unlockTitle(91);
		...
		if (title != null) {
			...
			/*if (titleId == 90 && !player.isTitleUnlocked(90)) {
				if (player.hasDiedBefore()) {
					player.sendMessage("You need to have never died before to unlock this title!");
					return;
				}
