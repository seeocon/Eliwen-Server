...
public final class Launcher {
    ...
    public static void main(String[] args) throws Exception {
    	...
    	try {
    		...
    		System.out.println("99.250.126.70: " + Settings.SERVER_NAME + " is starting up, please be patient...");
    		Cache.init();
    		ItemManager.inits();
    		ItemsEquipIds.init();
    		Huffman.init();
        ...
        System.out.println( Settings.SERVER_NAME + " is now Online (Port: "+Settings.PORT_ID+", Launch Time: "+((double)(end - start) / 1000)+"s)");
    }
