...
public final class sSettings {
	...
	public static final String SERVER_NAME = "Eliwen";
	public static int PORT_ID = 43594;
	
	public static final String[] OWNERS = { "hzy" };
	public static boolean ZOMBIE_ENABLED = true;
	
	//public static final WorldTile START_PLAYER_LOCATION = new WorldTile(2973, 3287, 0);
    public static final WorldTile START_PLAYER_LOCATION = new WorldTile(2203, 3253, 0);
	public static final WorldTile RESPAWN_PLAYER_LOCATION = new WorldTile(2203, 3253, 0);
